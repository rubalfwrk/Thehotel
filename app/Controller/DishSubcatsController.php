...
class DishSubcatsController extends AppController {
    ...
    public function admin_index() {
        $this->DishSubcat->recursive = 0;
        $this->paginate = array('conditions' => array('DishSubcat.isshow' => 0));
        $this->set('dishSubcats', $this->Paginator->paginate());
    }

    public function admin_assoindex() {
        $this->DishSubcat->recursive = 0;
        $this->paginate = array('conditions' => array('DishSubcat.isshow' => 1));
        $this->set('dishSubcats', $this->Paginator->paginate());
    }
    ...
    public function admin_add() {
        ...
        $dishCategories = $this->DishSubcat->DishCategory->find('list', array('conditions' => array('DishCategory.isshow' => 0)));
        $this->set(compact('dishCategories'));
    }
