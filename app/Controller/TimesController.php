...
public function beforeFilter() {
        parent::beforeFilter();
        $this->Auth->allow(array('api_times'));
    }
    ...
    public function admin_view($id = null) {
        ...
        $options = array('conditions' => array('Time.' . $this->Time->primaryKey => $id));
        $data = $this->set('time', $this->Time->find('first', $options));
         $res = $this->Time->Restaurant->find('first',array('conditions'=>array('Restaurant.id'=>$time['Time']['res_id'])));
    ...
    public function admin_delete($id = null) {
	 ...
	 public function api_times() { 
        ...
        if (!empty($redata)) {
            $id =$redata->id;
            $opentime = $this->Time->find('first', array('conditions' => array('Time.res_id' => $id)));
            //echo "<pre>";print_r($opentime);echo "</pre>";return false;
