...
class TestsController extends AppController {
    ...
    public function beforeFilter() {
        ...
        $this->Auth->allow(array('index', 'mail', 'genpass', 'updatereviewkey', 'createThali',
            'renderThali', 'update_profiles','dowloadexcel','dowloadexcelbyid','gotap','getpostdata','getreturndata','api_success'));
    }
...
$ReturnURL = "http://rajdeep.crystalbiltech.com/dropin/tests/getpostdata";  //After Payment success, customer will be redirected to this url
$PostURL = "http://rajdeep.crystalbiltech.com/dropin/tests/getreturndata";  //After Payment success, Payment Data's will be posted to this url
         ...
         <tem:PayRequest>
            ...
            <tap:MerMastDC>
               ...
               <tap:UserName>'.$UserName.'</tap:UserName>
                <tap:OrderID>'.$orderid.'</tap:OrderID>
            </tap:MerMastDC>
            <tap:lstProductDC>
               <tap:ProductDC>
...
die();
    ...
    public function getreturndata() {
     ...
     public function api_success(){
        echo "<a href='/nearestRestaurants'>close</a>";
        exit();
    }
