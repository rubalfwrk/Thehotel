        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
                <ul class="nav sidebar-nav">
                    ...
                    <li>
                        <?php echo $this->Html->link('Dish Sub hhAssociate Categories', array('controller' => 'dish_subcats', 'action' => 'assoadd', 'admin' => true), array('class' => 'dish_subcats_autorizemenu')); ?>
                    </li>                          
