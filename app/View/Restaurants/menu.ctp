...
<div class="banner_slide" style="width:100% !important; overflow:hidden; position:relative;"> 
   ...
   <div class="abcdef"> </div>
      ...
      <?php } ?>
                   <a class='one1' href="<?php echo $this->webroot; ?>restaurants/category/<?php echo $restaurant['Restaurant']['id']; ?>/0" class="active btn-rsrv-light3">Dine In</a>
	 ...
	 if($discategory['DishCategory']){
	   foreach ($discategory['DishCategory'] as $dact) {?>
     <?php } ?> 
                   <a class='one2' href="<?php echo $this->webroot; ?>restaurants/category/<?php echo $restaurant['Restaurant']['id']; ?>/1?pickup=yes" class="active btn-rsrv-light3">Pick Up</a>
                   
                   <!--<a class='one2' href="<?php //echo $this->webroot; ?>restaurants/category/<?php //echo $restaurant['Restaurant']['id']; ?>/<?php //echo $myid; ?>/1?pickup=yes" class="active btn-rsrv-light3">Pick Up</a>-->
