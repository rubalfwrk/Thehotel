        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">AddDishes</h3>
            </div>
   ...
   <?php if($loggeduser!=427){  ?>
        ...
        <?php //echo $this->Form->input('active', array('type' => 'checkbox')); ?>
            ...
            <script type="text/javascript">
                ...
                $('#proassociate').val('');
                var a = $('#rid').val();
                $.post("http://rajdeep.crystalbiltech.com/dropin/admin/products/getproduct", {'id': a}, function (d) {
                    var html = '';
                ...
                $.get("http://rajdeep.crystalbiltech.com/dropin/admin/products/getalergy", function (d) {
                    var html = '';
                    var data = jQuery.parseJSON(d);
                    console.log(data);
                    for (var key in data) {
