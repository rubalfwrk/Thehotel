   ...
   <div class="abcdef"> </div>
	  ...
	  if($discategory['DishCategory']){
	   foreach ($discategory['DishCategory'] as $dact) {?>
                   ...
                   <a class='one11' href="<?php echo $this->webroot; ?>restaurants/detail/<?php echo $restaurant['Restaurant']['id']; ?>/<?php echo $dact['id']; if($pickupcode){?>/1?pickup=yes<?php }else{echo '/0';}?>" class="active btn-rsrv-light3"><?php echo $dact['name']; ?></a>
