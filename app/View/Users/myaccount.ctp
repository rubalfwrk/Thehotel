...
<div class="banner_slide banner_slide1" style="width: 100% ! important; position: relative; overflow: hidden; height: 246px !important;"> <img style="width: 100% ! important; position: absolute; top: 0px; left: 0px; right: 0px; bottom: 0px; margin: auto;" src="<?php echo $this->webroot ?>home/img/restaurantss.jpg" class="banner_img" />
  <h2>Profile</h2>
  <div class="abcdef"> </div>
</div>
...
<div class="container">
  <div class="row">
   ...
   <div class="box5533">
					<input style="position: absolute;z-index: -1;top: 128px;width: 100%;
right: 0;left: 0;text-align: center;margin: auto;" type="file" name="data[User][image]" value="" id="file-2" class="inputfile inputfile-2" data-multiple-caption="{count} files selected" multiple />
					<label style="color:#fc0;" for="file-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Choose a file&hellip;</span></label>
				</div>
    ...
    <input style="margin-left:30px;" type="submit" name="submit" value="submit" class="upload_pic12">
        ...
        <div class="col-sm-8">
        	<div class="detail_prf">
                <span class="text2 text4"><b>Name </b>: <?php echo $data['User']['name']; ?> </span> 
                <span class="text2 text4"><b>E-mail</b>: <?php echo $data['User']['username']; ?> </span>
                <span class="text2 text4"><b>User Name</b>: <?php echo $data['User']['email']; ?> </span>
          ...
          <!--<table class="table" border="none">
            <thead>
              <tr>
                <th style="background: #fc0;border: 1px solid #ccc;" colspan="2"> <span class="offers_hst">USER PROFILE DETAILS </span></th>
              </tr>
            </thead>
            <tbody>
   ...
   <div class="box5533">
					<input style="position: absolute;z-index: -1;top: 9px;" type="file" name="data[User][image]" value="" id="file-2" class="inputfile inputfile-2" data-multiple-caption="{count} files selected" multiple />
					<label style="color:#fc0;" for="file-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>Choose a file&hellip;</span></label>
				</div>
    ...
    <input style="margin-left:30px;" type="submit" name="submit" value="submit" class="upload_pic12">
                ...
                <span class="text1 text3"><b> </b> <?php echo $data['User']['name']; ?> </span></a> 
                <span class="text2 text4"><b>E-mail</b>: <?php echo $data['User']['username']; ?> </span>
                <span class="text2 text4"><b>User</b>: <?php echo $data['User']['email']; ?> </span>
            ...
            <tfoot>
              <tr>
                <td colspan="2"><span class="btn_horder btn_horder1 ">
                  <a href="<?php echo $this->webroot; ?>users/edit" class="btn btn-primary  "> EDIT PROFILE</a>
                  </span></td>
              </tr>
            </tfoot>
          </table>-->
        </div>
		<div class="col-sm-12"><a href="<?php echo $this->webroot; ?>users/edit" class="btn btn-primary  "> EDIT PROFILE</a></div>
      </div>
