 ...
 <section class="content">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $time['Time']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $time['Time']['id']),'class'=>'btn btn-danger btn-xs')); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
