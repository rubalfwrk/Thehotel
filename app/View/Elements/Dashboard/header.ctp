<link rel="stylesheet" type="text/css" href="<?php echo $this->webroot;?>css/admin_custom.css">
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        <header class="main-header">
            <!-- Logo -->
            <a href="<?php echo $this->webroot?>admin/users" class="logo">
...
<!--                        <li class="dropdown tasks-menu">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo $this->request->webroot ?>profile_pic/default.jpg" class="user-image" alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        <!-- small>Member since <?php //echo $userdata['created_date']; ?></small> -->
                                    </p>
                                </li>
                                <!-- Menu Body -->
<!--                                <li class="user-body">
